    ...
    Controller_Output_t &u)
{
  /* WRITE YOUR CODE HERE */
      ...
      Eigen::Vector3d delta_x(0.0, 0.0, 0.0);
      Eigen::Vector3d delta_p(-0.07, -0.03, -0.02);
      Kp << param_.gain.Kp0, param_.gain.Kp1, param_.gain.Kp2;
      Kv << param_.gain.Kv0, param_.gain.Kv1, param_.gain.Kv2;
      des_acc = des.a + Kv.asDiagonal() * (des.v - odom.v) + Kp.asDiagonal() * (des.p - odom.p + delta_p);
      des_acc += Eigen::Vector3d(0,0,param_.gra);
      delta_x = des.p - odom.p;
      ROS_INFO("x-error: %f, %f, %f", delta_x(0), delta_x(1), delta_x(2));
